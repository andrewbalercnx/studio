...
class StoryPicClient {
     ...
     */
    async createStorybook(storyId, outputTypeId, styleId, imageStylePrompt) {
        const body = { storyId, outputTypeId, styleId, imageStylePrompt };
        const response = await this.post('/storybookV2/create', body);
