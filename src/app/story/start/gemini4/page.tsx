...
export default function StartGemini4StoryPage() {
  ...
  useEffect(() => {
    ...
    const startGemini4Story = async () => {
      ...
      try {
        ...
        // Create story session with gemini4 mode
        ...
        // Navigate to play page which will trigger the first Gemini 4 question
        router.push(`/story/play/${storySessionId}`);

      } catch (e: any) {
        console.error("Error starting Gemini 4 story:", e);
  ...
  return (
    <div className="container mx-auto flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md text-center">
        <CardHeader>
          <CardTitle>Starting Your Story Adventure</CardTitle>
          <CardDescription>
            Get ready for a personalized story created just for you!
          </CardDescription>
        </CardHeader>
