...
import { LoaderCircle, PlusCircle, ImageIcon, Sparkles, Upload } from 'lucide-react';
...
export default function AdminStoryOutputsPage() {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      ...
      <DiagnosticsPanel pageName="admin-storyOutputs" data={diagnostics} className="mt-8" />
    </div>
  );
}
