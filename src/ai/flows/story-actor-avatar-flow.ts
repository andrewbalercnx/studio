...
- Characters should be cute and age-appropriate for young children`,
      ...
      if (!dataUrl) {
        ...
        await logAIFlow({ flowName: 'storyActorAvatarFlow', sessionId: storyId, parentId: story.parentUid, prompt: promptText, response: llmResponse, startTime, modelName, isFailure: true, failureReason });
